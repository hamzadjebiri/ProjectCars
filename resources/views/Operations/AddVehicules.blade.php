...
.centered-form .panel{
  ...
  /* */
        ...
        <div class="row centered-form modal fade" id="véhicule" role="dialog">
              ...
              <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4 modal-dialog col-lg-12">
                   ...
                   <div class="panel panel-default">
                          ...
                          <div class="panel-heading">
                            ...
                            <h3 class="panel-title">Ajouter   Une Véhicule </h3>
                      ...
                      <div class="panel-body">
                           ...
                           <form role="form" action="AddVéhicule" method="post">
                              {{ csrf_field() }} 
